...
urlpatterns = [
	...
	url(r'^mess_refund_accept/(?P<pk>\d+)', views.mess_refund_accept, name="mess_refund_accept"),
	url(r'^mess_refund_reject/(?P<pk>\d+)', views.mess_refund_reject, name="mess_refund_reject"),
	url(r'^mess_leave_accept/(?P<pk>\d+)', views.mess_leave_accept, name="mess_leave_accept"),
	url(r'^mess_leave_reject/(?P<pk>\d+)', views.mess_leave_reject, name="mess_leave_reject"),
