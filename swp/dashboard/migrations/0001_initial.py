    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(default=datetime.datetime(2018, 11, 15, 14, 43, 26, 206162, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('announcement_title', models.CharField(blank=True, max_length=30, null=True)),
                ('announcement', models.CharField(blank=True, max_length=100, null=True)),
                ('timestamp', models.DateTimeField(default=datetime.datetime(2018, 11, 15, 14, 43, 26, 207267, tzinfo=utc))),
                ('created_at', models.DateField(blank=True, null=True)),
                ('created_by', models.CharField(blank=True, max_length=45, null=True)),
                ('modified_at', models.DateField(blank=True, null=True)),
                ('modified_by', models.CharField(blank=True, max_length=45, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('announcement_title', models.CharField(blank=True, max_length=30, null=True)),
                ('announcement', models.CharField(blank=True, max_length=100, null=True)),
                ('timestamp', models.DateTimeField(default=datetime.datetime(2018, 11, 15, 14, 43, 26, 206697, tzinfo=utc))),
                ('created_at', models.DateField(blank=True, null=True)),
                ('created_by', models.CharField(blank=True, max_length=45, null=True)),
                ('modified_at', models.DateField(blank=True, null=True)),
                ('modified_by', models.CharField(blank=True, max_length=45, null=True)),
